...
ble_server::DeviceInformationBleService deviceInfoBleService(lib);
...
void setup() {
  ...
  // setup device information ble services
  deviceInfoBleService.setFirmwareRevision("1.2.3");
  deviceInfoBleService.setManufacturerName("DiY Corp");
  deviceInfoBleService.setModelNumber("MyGadget rev1");
  uptBleServer.registerBleServiceProvider(deviceInfoBleService);
